...
notEqualsBO :: Parser BO
notEqualsBO = notEquals *> return NotEq
...
lessThanBO :: Parser BO
lessThanBO = lessThan *> return LessThan
...
greaterThanBO :: Parser BO
greaterThanBO = greaterThan *> return GreaterThan
